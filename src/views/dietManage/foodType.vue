<template>
  ...
  <el-card>
    ...
    <div class="topStyle">
      ...
      <!-- 新建 -->
      <div>
        <el-button type="primary" @click="Create">新建分类</el-button>
      </div>
    </div>
    ...
    <div style="margin-top:30px;">
      <div>
        ...
        <el-table :data='tableData' 
          ...
          <el-table-column label="典型例子" align='center'>
    ...
    <el-dialog :title="addType[dialogStatus]"  :visible.sync="dialogFormVisible" width=35vw>
      <el-form :model="form" :rules="rules" ref="form">
        ...
        <el-form-item label="典型例子" :label-width="formLabelWidth" prop="role">
            <el-input v-model="form.role" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="xxx" :label-width="formLabelWidth" prop="xxx">
